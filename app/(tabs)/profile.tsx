...
// Acentos de dados na paleta terrosa (azul-ardósia, musgo, casca, âmbar)
const IMPACT_METRICS = [
  { key: "water_l", label: "Água", unit: "L", color: "#6B8BA4" },
  { key: "co2_kg", label: "CO2", unit: "kg", color: "#6F7F5C" },
  { key: "waste_g", label: "Resíduos", unit: "g", color: "#8A6F55" },
  { key: "energy_kwh", label: "Energia", unit: "kWh", color: "#B08A4B" },
] as const;
  ...
  if (loading) {
    return (
      <View style={styles.loadingScreen}>
        ...
        <ActivityIndicator color={T.moss} size="large" />
      </View>
    );
  }
...
const makeStyles = (T: RootineTheme) =>
  StyleSheet.create({
    ...
    userXp: { fontSize: 13, color: T.accent, fontWeight: "700", marginTop: 5, letterSpacing: 0.4 },
    userProgress: { color: T.inkSoft, marginTop: 3, fontWeight: "500" },
    tabs: {
      width: "100%",
      maxWidth: 720,
      flexDirection: "row",
    ...
    infoButtonText: { color: T.chipText, fontWeight: "700", fontSize: 14 },
    sectionSubtitle: {
      fontFamily: Fonts.serif,
      color: T.ink,
      fontWeight: "600",
    ...
    statLabel: { color: T.inkSoft, marginTop: 4, fontWeight: "600", fontSize: 12 },
    formulaText: { color: T.inkFaint, marginTop: 8, marginBottom: 8, fontSize: 12, lineHeight: 18 },
    impactBlock: { borderTopWidth: 1, borderTopColor: T.cardBorder, paddingTop: 10, marginTop: 10 },
    impactTitle: { color: T.ink, fontWeight: "700", marginBottom: 10 },
    ...
    impactMetricLabel: { color: T.inkSoft, fontWeight: "700", fontSize: 12 },
    impactMetricValue: {
      fontFamily: Fonts.serif,
      color: T.ink,
      fontWeight: "600",
    ...
    impactMetricUnit: { color: T.inkSoft, fontSize: 12, fontWeight: "600" },
    impactMetricHint: { color: T.inkFaint, fontSize: 11, marginTop: 3, fontWeight: "600" },
    achievement: {
      borderWidth: 1,
      borderColor: T.cardBorder,
      borderRadius: 18,
    ...
    achievementUnlocked: { borderColor: T.chipBorder, backgroundColor: T.chipBg },
    achievementTitle: {
      fontFamily: Fonts.serif,
      fontWeight: "600",
      color: T.ink,
    ...
    achievementDescription: { color: T.inkSoft, marginTop: 4, lineHeight: 20 },
    achievementStatus: { color: T.mossDeep, marginTop: 8, fontWeight: "700", fontSize: 12.5 },
    historyItem: { borderBottomWidth: 1, borderBottomColor: T.cardBorder, paddingVertical: 11 },
    historyTitle: { color: T.ink, fontWeight: "600", lineHeight: 20 },
    historyMeta: { color: T.inkFaint, marginTop: 3, fontSize: 12 },
    factCard: {
      borderWidth: 1,
      borderColor: T.cardBorder,
      borderRadius: 18,
    ...
    helpTitle: { color: T.chipText, fontWeight: "700", marginBottom: 6 },
    helpText: { color: T.inkSoft, fontSize: 12, lineHeight: 18, marginTop: 4 },
    ...
    factChipText: { color: T.chipText, fontSize: 11, fontWeight: "700" },
    factConfidence: { color: T.inkFaint, fontSize: 11, fontWeight: "700" },
    factTitle: { color: T.ink, fontWeight: "600", marginTop: 10, lineHeight: 21 },
    factMeta: { color: T.inkFaint, marginTop: 6, lineHeight: 18, fontSize: 12 },
    ...
    factButtonText: { color: T.inkSoft, fontWeight: "700", fontSize: 11 },
    emptyText: { color: T.inkFaint, lineHeight: 20 },
    scientistIntro: { color: T.inkSoft, lineHeight: 20, marginBottom: 12 },
    chatBox: {
      backgroundColor: T.inputBg,
      borderWidth: 1,
      borderColor: T.inputBorder,
    ...
    userBubble: { backgroundColor: T.claySoft, alignSelf: "flex-end" },
    assistantBubble: { backgroundColor: T.chipBg, alignSelf: "flex-start" },
    messageText: { color: T.ink, lineHeight: 20 },
    input: {
      backgroundColor: T.inputBg,
      borderWidth: 1,
      borderColor: T.inputBorder,
    ...
    sendText: { color: T.onMoss, fontWeight: "700", letterSpacing: 0.3 },
  });
